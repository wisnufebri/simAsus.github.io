                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                        ...
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="pageAdmin/karyawan.php">Progres Pegawai
                            </a>
                            <a class="nav-link" href="pageAdmin/layout-sidenav-light.php">Data Pegawai
                            </a>
                        </nav>
                    </div>
                        ...
                        <div class="modal-dialog">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if (mysqli_num_rows($cek) == 0) {
                                    ...
                                    if ($sql) {
                                        echo '<script>alert("Berhasil menambahkan data."); document.location="halaman_admin.php";</script>';
                                    } else {
                            ...
                            <div class="modal-content">
                                <form action="halaman_admin.php" method="post" class="modal-body">
                                    ...
                                    <div class="modal-footer" action="halaman_admin.php" method="post">
...
<td>' . $data['jurusan'] . '</td>
 <td>
								<a href="./pageAdmin/adminUpdate.php?id=' . $data['id'] . '" class="badge badge-warning">Edit</a>
								<a href="./pageAdmin/adminDelete.php?id=' . $data['id'] . '" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
							</td>
</tr>
';
                                        $no++;
