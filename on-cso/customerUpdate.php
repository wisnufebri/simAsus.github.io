...
<div class="container" style="margin-top:20px">
    ...
    <form action="customer-cso.php?id=<?php echo $id; ?>" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="serial_number" class="form-control"
                       value="<?php echo $data['serial_number']; ?>" required>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select name="model" class="form-control" required>
                    ...
                    <option value="NOTEBOOK" <?php if($data['model'] == 'NOTEBOOK'){ echo 'selected'; } ?>>NOTEBOOK</option>
                    <option value="ZENFONE" <?php if($data['model'] == 'ZENFONE'){ echo 'selected'; } ?>>ZENFONE</option>
                </select>
            </div>
        </div>
        <!--    dropdown status    -->
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select name="status" class="form-control" required>
                    ...
                    <option value="REPAIR" <?php if($data['status'] == 'REPAIR'){ echo 'selected'; } ?>>REPAIR</option>
                    <option value="READY" <?php if($data['status'] == 'READY'){ echo 'selected'; } ?>>READY</option>
                    <option value="SHIP" <?php if($data['status'] == 'SHIP'){ echo 'selected'; } ?>>SHIP</option>
