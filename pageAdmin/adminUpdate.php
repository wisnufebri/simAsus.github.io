    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../halaman_admin.php">Tambah</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container" style="margin-top:20px">
    ...
    if(isset($_POST['submit'])){
        ...
        if($sql){
            echo '<script>alert("Berhasil menyimpan data."); document.location="adminUpdate.php?id='.$id.'";</script>';
        }else{
    ...
    <form action="adminUpdate.php?id=<?php echo $id; ?>" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="submit" href="halaman_admin.php" name="submit" class="btn btn-primary" value="SIMPAN">
                <a href="../halaman_admin.php" class="btn btn-warning">KEMBALI</a>
            </div>
        </div>
    </form>
