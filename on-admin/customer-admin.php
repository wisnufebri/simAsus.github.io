                            ...
                            <div class="modal-dialog">
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    if (mysqli_num_rows($cek) == 0) {
                                        $sql = mysqli_query($koneksi, "INSERT INTO customer(tanggal_masuk, rma, nama, no_telpon, serial_number, model, status, posisi_rak, memo, teknisi) VALUES
                                        ('$tanggal_masuk', '$rma', '$nama', '$no_telpon', '$serial_number', '$model', '$status', '$posisi_rak', '$memo', '$teknisi')") or die(mysqli_error($koneksi));
                                        if ($sql) {
                                            echo '<script>alert("Berhasil menambahkan data."); document.location="customer-admin.php";</script>';
                                        } else {
                                ...
                                <div class="modal-content">
                                    <form action="customer-admin.php" method="post" class="modal-body">
                                        ...
                                        <div class="modal-footer" action="customer-admin.php" method="post">
                    ...
                    <div class="modal fade" id="myModal2" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                ?>
                                <form action="customer-admin.php?id=<?php echo $id; ?>" method="post" class="modal-body">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">RMA</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="rma" class="form-control" size="4" value="<?php echo $data['rma']; ?>" readonly required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <input type="text" name="model" class="form-control" value="<?php echo $data['model']; ?>" required readonly>
                                        </div>
                                    </div>
                                    <!--    dropdown    -->
                                    <div class="form-group row">
