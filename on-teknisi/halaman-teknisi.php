                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    $sql = mysqli_query($koneksi, "UPDATE customer SET poisi_rak='$posisi_rak', memo='$memo' WHERE id='$id'") or die(mysqli_error($koneksi));
                                ...
                                ?>
                                <form action="customerUpdate.php?id=<?php echo $id; ?>" method="post"
                                    class="modal-body">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">NIM</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="posisi_rak" class="form-control" size="4"
                                                value="<?php echo $data2['posisi_rak']; ?>" readonly required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="memo" class="form-control"
                                                value="<?php echo $data2['memo']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="submit" href="halaman-teknisi.php" name="submit"
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <thead>
                                                <tr class="nol">
                                                    ...
                                                    <th class="main">POSISI RAK</th>
                                                    <th class="main">MEMO</th>
                                            ...
                                            <tr class="nol1">
                                                ...
                                                <td class="main2"><?php echo $posisi_rak; ?></td>
                                                <td class="main2"><?php echo $memo; ?></td>
